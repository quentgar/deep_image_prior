    ...
    def __init__(self,input_depth=32,output_depth=3,
        ...
        for i in range(num_scales):
          ...
          if i == (num_scales-1):
            ...
            attributes.append(('d'+str(i+1),roto_decoder_block(num_channels_up[i+1]+num_channels_skip[i], num_channels_up[i], 9, 8, up_sampling_mode=up_samp_mode).type(torch.cuda.FloatTensor)))
